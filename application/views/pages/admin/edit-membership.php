...
$package = $this->admin->membershipById($id);
    ...
    <div class="col-md-7">
        ...
        <form id="addBanners">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="desc_membership"><?php echo $package->desc_membership; ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input <?php if ($package->show_in_homepage == "on") {
                            echo "checked";
                        } ?> type="checkbox" value="<?php echo $package->show_in_homepage; ?>" name="show_in_homepage">
            </div>
            <div class="form-group">
                <label>Price:</label>
...
<script>
    ...
    var services = [],
        count = <?php echo count($packageServices); ?>,
        countArr = [],
        pArr = [];
